...
class ContainerControl extends React.Component {	// methods in order, constructor first, render last, events & function in the middle
    constructor(props) {
        ...
        this.IsDisplayed = this.props.IsDisplayed;
        ...
        this.UserContainer = React.createElement("div", { className: 'me-control-container ' + this.state.currentContainerCssClass, key: Utilities.NewId() }, _d, _e, _i);

        this.test = React.createElement("div", { className: 'test', key: Utilities.NewId() }, "testing");
    ...
    render() {
        ...
        let hideOrDisplay;
        console.debug("this.IsDisplayed", this.IsDisplayed);
        if (this.IsDisplayed == false) {
            hideOrDisplay = { display: 'none' };
        }
        else if (this.IsDisplayed == true) {
            hideOrDisplay = { display: 'block' };
        }
